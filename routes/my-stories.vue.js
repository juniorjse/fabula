    ...
    <div class="min-h-screen bg-neutral-light pb-16">
      ...
      <main class="max-w-4xl mx-auto px-4 pt-4 relative z-10">
        <div class="mb-8 text-center">
          ...
          <p class="text-neutral-dark font-body">Histórias personalizadas da fauna brasileira criadas para você</p>
                    </div>
        ...
        <div v-if="stories.length > 0" class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div v-for="story in stories" :key="story.id" class="bg-neutral-light/70 rounded-lg overflow-hidden shadow-lg border border-neutral-dark transform transition hover:scale-[1.02]">
            <div class="flex flex-col h-full">
              <!-- Story Image -->
              <div class="h-48 overflow-hidden bg-tertiary flex items-center justify-center">
                <i class="fas fa-book-open text-4xl text-white"></i>
                </div>

              <!-- Story Info -->
              <div class="p-4 flex flex-col flex-grow">
                <h2 class="font-heading font-bold text-xl text-primary-dark mb-2">{{ story.title }}</h2>
                ...
                <p class="text-neutral-dark text-sm mb-4 line-clamp-3">
                  {{ story.content.substring(0, 120) }}...
                </p>
                
                <div class="text-xs text-neutral-dark/70 mb-4 mt-auto">
        ...
        <div v-else class="bg-neutral-light/70 rounded-lg p-8 shadow-lg border border-neutral-dark text-center">
          <div class="mb-8">
            ...
            <p class="text-neutral-dark mt-2 font-body mb-6">Você ainda não criou nenhuma história personalizada</p>
